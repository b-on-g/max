...
;
	($.$bog_max_app) = class $bog_max_app extends ($.$mol_page) {
		Welcome(){
			const obj = new this.$.$mol_text();
		...
		Sources(){
			...
			(obj.uri) = () => ("https://github.com/b-on-g/max");
			return obj;
		}
		Status(){
		...
		title(){
			return (this.$.$mol_locale.text("$bog_max_app_title"));
		}
		pages(){
	...
	($mol_mem(($.$bog_max_app.prototype), "Welcome"));
	($mol_mem(($.$bog_max_app.prototype), "Home"));
	($mol_mem(($.$bog_max_app.prototype), "screen"));
	($mol_mem(($.$bog_max_app.prototype), "Sources"));
	($mol_mem(($.$bog_max_app.prototype), "Status"));
	($mol_mem(($.$bog_max_app.prototype), "Theme_toggle"));
	($mol_mem(($.$bog_max_app.prototype), "Theme"));
	($mol_mem(($.$bog_max_app.prototype), "Navbar"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_max_app.prototype, "screen_body", null);
